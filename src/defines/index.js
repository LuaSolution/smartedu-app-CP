...
export const CHAT_SOCKET =
  process.env.REACT_APP_LOCAL === 'true'
    ? 'http://localhost:3002/'
    : 'https://ifa-socket-server-rfcvd.ondigitalocean.app/'
export const VIDEO_SOCKET =
  process.env.REACT_APP_LOCAL === 'true'
    ? 'http://localhost:3002/'
    : 'https://ifa-socket-server-rfcvd.ondigitalocean.app/'
export const AVATAR_PATH = ROOT + 'storage/app/public/user-avatars/'
export const CATE_PATH = ROOT + 'storage/app/public/categories/'
export const NEWS_PATH = ROOT + 'storage/app/public/news/'
export const EX_CERTIFICATE_PATH = ROOT + 'storage/app/public/ex-certificates/'
export const COURSES_PATH = ROOT + 'storage/app/public/courses/'

export const VIDEO = 1
export const DOCUMENT = 2
export const SCORM = 3
export const EXAM = 4
...
export const userLevel = ['ROOT', 'Quản trị viên', 'Giảng viên', 'Học viên']
export const userLevelVN = ['ROOT', 'Quản trị viên', 'Giảng viên', 'Học viên']
...
export const genderColor = ['danger', 'secondary']
export const GENDER = ['', 'Nam', 'Nữ']
export const PARTNER_TYPE = ['Công ty', 'Trường học']
