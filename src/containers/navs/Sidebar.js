...
import menuItems from 'defines/menu'
...
class Sidebar extends Component {
  ...
  getIsHasSubItem = () => {
    ...
    return menuItem ? menuItem && menuItem.subs && menuItem.subs.length > 0 : false
  };
    ...
    return (
      <div className="sidebar">
        <div className="main-menu">
          <div className="scroll scrollbar" style={{ overflow: 'overlay' }} >
