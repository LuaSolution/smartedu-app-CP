...
const SubUserList = ({ partnerId = null, courseId = null, courseInfo }) => {
  ...
  useEffect(() => {
    const fetchData = () => {
      const url = partnerId ? 'admin/partners/users/paging' :
        courseId ? 'admin/user/paging-by-course' : null
    ...
    fetchData()
  }, [selectedPageSize, currentPage, selectedOrderOption, search, courseInfo['refresh']])
