...
const MyLearningProcess = ({ id }) => {
  ...
  const renderData = (item, index) => {
    const content = (
      <div className="item-process-td">
        ...
        >
          <img
            src={COURSES_PATH + item.id + '.webp'}
            className="style-image-detail"
          />
        </div>
        <div
        ...
        {item.cetificate_name && (
          <>
            <div className="content-footer-1">
              <img
                src={COURSES_PATH + item.id + '.webp'}
                className="style-image-content-1"
              />
    ...
    const process = (
      <td className="item-line-middle">
        <div className="box-line-process">
          <Progress
            className="process-learning-middle"
            type="circle"
    ...
    return (
      <>
        <tr className="item-row-line-learing-process" key={index}>
          {index % 2 ? (
            <>
              <td></td>
              {process}
              <td className="item-line-center-right">{content}</td>
            </>
          ) : (
            <>
              <td className="item-line-center-left">{content}</td>
              {process}
              <td></td>
            </>
          )}
  ...
  return (
    <div
      className="box-content-process-learning"
