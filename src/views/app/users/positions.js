...
import AddNewModal from 'containers/positions/addAndEdit'
import ListData from 'containers/positions/listData'
...
const PositionsPage = ({
  ...
  const onContextMenuClick = (e, data) => {
    ...
    if (data.action === 'delete') {
      ...
      props.history.push('/app/users/positions?p=' + selectedItems[0])
    }
  }
  ...
  const toggleModal = () => {
    if (modalOpen) {
      props.history.push('/app/users/positions')
    }
...
export default React.memo(PositionsPage)