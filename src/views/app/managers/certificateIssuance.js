...
import AddNewModal from 'containers/certificateIssuance/addAndEdit'
import UserList from 'containers/certificateIssuance'
...
const UsersPages = ({ match, ...props }) => {
  ...
  const toggleModal = () => {
    if (modalOpen) {
      props.history.push('/app/managers/certificate-issuance')
    }
  ...
  return <Spin spinning={loading} tip="Loading...">
    <div className="disable-text-selection">
      <ListPageHeading
        heading="managers.certificate-issuance"
