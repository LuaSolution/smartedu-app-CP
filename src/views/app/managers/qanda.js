...
import AddNewModal from 'containers/qanda/addAndEdit'
import ListData from 'containers/qanda/listData'
...
const QandaPage = ({ match, deleteUsers, loading, ...props }) => {
  ...
  const onContextMenuClick = (e, data) => {
    if (data.action === 'delete') {
      ...
      props.history.push('/app/managers/qanda?p=' + selectedItems[0])
    }
  }
  ...
  const toggleModal = () => {
    if (modalOpen) {
      props.history.push('/app/managers/qanda')
    }
