...
import AddNewModal from 'containers/orders/addAndEdit'
import ListData from 'containers/orders/listData'
...
const OrdersPage = ({ match, ...props }) => {
  ...
  const onContextMenuClick = (e, data) => {
    if (data.action === 'delete') {
      ...
      props.history.push('/app/orders/default?p=' + selectedItems[0])
    }
  }
  ...
  const toggleModal = () => {
    if (modalOpen) {
      props.history.push('/app/orders/default')
    }
